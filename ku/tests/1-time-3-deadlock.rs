...
#[rstest]
#[should_panic(expected = "ku/tests/1-time-3-deadlock.rs:50")]
#[timeout(Duration::from_secs(10))]
...
#[rstest]
#[should_panic(expected = "ku/tests/1-time-3-deadlock.rs:51")]
#[timeout(Duration::from_secs(10))]
...
#[rstest]
#[should_panic(expected = "ku/tests/1-time-3-deadlock.rs:54")]
#[timeout(Duration::from_secs(10))]
