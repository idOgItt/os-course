...
fn test_file_shell() {
    run_shell(|send, recv| {
        ...
        send("cat /tmp/zog\n".to_string());
        assert_eq!(recv().trim(), "6".to_string());
    })
}
...
fn test_pipe_shell() {
    run_shell(|send, recv| {
        ...
        // send("echo hello | cat".to_string());
        // assert_eq!(recv(), "hello".to_string());
        //
        // send("echo hello | cat\n".to_string());
        // assert_eq!(recv(), "hello\n".to_string());
        //
        // send("echo hello | cat | cat\n".to_string());
        // assert_eq!(recv(), "hello\n".to_string());
