...
fn init_smp(phys2virt: Page, subsystems: Subsystems) -> Result<()> {
...
pub mod test_scaffolding {
    ...
    pub use super::{cpu::test_scaffolding::*, local_apic::test_scaffolding::*};
    ...
    pub fn init_smp(phys2virt: Page, subsystems: Subsystems) -> Result<()> {
