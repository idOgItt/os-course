...
- [Время и параллельный код](1-time-0-intro.md)
  - [Часы реального времени](1-time-1-rtc.md)
  - [Счётчик тактов процессора](1-time-2-tsc.md)
  - [Спин–блокировка](1-time-3-spinlock.md)
  - [Sequence lock](1-time-4-sequence-lock.md)
  - [Счётчики тиков](1-time-5-correlation-point.md)
  - [Измерение частоты процессора и повышение разрешения часов](1-time-6-correlation-interval.md)
  - [Обработка прерываний RTC](1-time-7-interrupts.md)
  - [Информация о системе](1-time-8-info.md)
  - [Собираем всё вместе](1-time-9-summary.md)
