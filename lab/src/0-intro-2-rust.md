...
Rust имеет те же свойства, но в дополнение предоставляет:
...
Мы будем пользоваться [nightly](https://doc.rust-lang.ru/book/appendix-07-nightly-rust.html) Rust [редакции 2024](https://doc.rust-lang.org/edition-guide/rust-2024/index.html).
...
и
[`alloc::collections::BTreeMap`](https://doc.rust-lang.org/nightly/alloc/collections/btree_map/struct.BTreeMap.html)
будут нам доступны.
