...
```
Так как мы пока не откалибровали частоту процессора, в этой строке точность времени указана в тысячах его тиков --- `ktsc`.
Потом тикает PIT:
```console
...
Если запустить Nikka на железе, то получаем примерно 30--80 тактов, или около 10-20 наносекунд:
...
>
> - [Сурдин В.Г. - Общая астрономия - 3. Время и календарь](https://www.youtube.com/watch?v=9agICl7sIrM).
