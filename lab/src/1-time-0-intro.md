...
Также станет доступна отладка
[взаимоблокировок](https://en.wikipedia.org/wiki/Deadlock),
что тоже сделает решение последующих лабораторок удобнее.
...
```console
 ...
 ku/src/sync/sequence_lock.rs        |  92 ++++++++++++++++++++++++++++++++++++++++++++++++++++----------
 ku/src/sync/spinlock.rs             | 110 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++--------------
 ku/src/time/correlation_interval.rs |  27 +++++++++++++++++--
