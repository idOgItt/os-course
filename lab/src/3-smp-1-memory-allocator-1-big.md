...
Если запрошенные флаги `flags` не допускаются этим аллокатором, 
метод возвращает ошибку [`Error::PermissionDenied`](../../doc/ku/error/enum.Error.html#variant.PermissionDenied).
