...
Для низкоуровневого хранения величин, вроде адресов, номеров и т.д. можно было бы использовать любой из этих примитивных типов:
...
- [`ku::memory::size::from(x: u64)`](../../doc/ku/memory/size/fn.from.html)
